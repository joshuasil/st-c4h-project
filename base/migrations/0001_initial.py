# Generated by Django 4.2.9 on 2024-01-09 01:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone_number', models.TextField(help_text='Enter the 11 digit phone number in the format 1234567890 (no spaces or dashes).', unique=True, validators=[django.core.validators.RegexValidator(code='invalid_phone_number', message='Phone number must be exactly 11 digits long.', regex='^\\d{11}$')])),
                ('phone_number_key', models.BinaryField()),
                ('phone_number_hash', models.CharField(blank=True, max_length=64, null=True, unique=True)),
                ('name', models.TextField(blank=True, help_text='Enter a first name for this number.', null=True)),
